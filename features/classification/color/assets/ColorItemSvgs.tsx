...
import { getCategoryVariants } from "../../../../utils/colorUtils";
...
export const Apple = ({ colorHex }: ItemSvgProps) => {
  const colors = getCategoryVariants(colorHex);
  return (
...
const Balloon = ({ colorHex }: ItemSvgProps) => {
  ...
  return (
    <Svg width="100" height="100" viewBox="0 0 100 100">
      ...
      <Polygon points="46,69 54,69 50,77" fill={colors.base} />
...
const Bee = ({ colorHex }: ItemSvgProps) => {
  const colors = getCategoryVariants(colorHex);
  return (
    <Svg width="100" height="100" viewBox="0 0 100 100">
      {/* 날개 */}
      ...
      {/* 줄무늬 */}
      <Path d="M32 50 H68" stroke={colors.darker} strokeWidth="5" />
      <Path d="M30 61 H70" stroke={colors.darker} strokeWidth="5" />
      <Path d="M35 72 H65" stroke={colors.darker} strokeWidth="5" />

      {/* 얼굴 */}
      <Circle cx="42" cy="43" r="3" fill={DARK} />
      <Circle cx="58" cy="43" r="3" fill={DARK} />
...
const Watermelon = ({ colorHex }: ItemSvgProps) => {
  const colors = getCategoryVariants(colorHex);
  return (
    <Svg width="100" height="100" viewBox="0 0 100 100">
      {/* ======================
...
const Ladybug = ({ colorHex }: ItemSvgProps) => {
  ...
  return (
    <Svg width="100" height="100" viewBox="0 0 100 100">
      ...
      {/* 점 무늬 */}
      <Circle cx="34" cy="56" r="6" fill={colors.darker} />
      <Circle cx="34" cy="76" r="6" fill={colors.darker} />
      <Circle cx="66" cy="56" r="6" fill={colors.darker} />
      <Circle cx="66" cy="76" r="6" fill={colors.darker} />
...
const Chick = ({ colorHex }: ItemSvgProps) => {
  ...
  return (
    <Svg width="100" height="100" viewBox="0 0 100 100">
      ...
      />
      {/* 눈 */}
      <Circle cx="40" cy="52" r="4" fill={colors.darker} />
      <Circle cx="60" cy="52" r="4" fill={DARK} />
      <Circle cx="41.2" cy="51" r="1.2" fill={WHITE} />
      <Circle cx="61.2" cy="51" r="1.2" fill={WHITE} />
      {/* 부리 */}
      ...
      />
      {/* 볼터치 */}
      <Circle cx="37" cy="62" r="4" fill={WHITE} opacity={0.5} />
      <Circle cx="63" cy="62" r="4" fill={WHITE} opacity={0.5} />
    </Svg>
  );
};
...
const Sunflower = ({ colorHex }: ItemSvgProps) => {
  ...
  return (
    <Svg width="90" height="90" viewBox="0 0 100 100">
      ...
      />
      {/* 씨앗 질감 점들 */}
      <Circle cx="45" cy="46" r="1.6" fill={colors.dark} />
      <Circle cx="55" cy="46" r="1.6" fill={colors.dark} />
      <Circle cx="50" cy="52" r="1.6" fill={colors.dark} />
      <Circle cx="44" cy="54" r="1.6" fill={colors.dark} />
      <Circle cx="56" cy="54" r="1.6" fill={colors.dark} />
    </Svg>
  );
};
...
const Tree = ({ colorHex }: ItemSvgProps) => {
  ...
  return (
    <Svg width="100" height="100" viewBox="0 0 100 100">
      ...
      <Circle cx="35" cy="44" r="15" fill={colors.base} />
      <Circle cx="65" cy="44" r="15" fill={colors.base} />
