...
// ------------------------------------------------------------
// // 🔘 단추
export const Button1 = ({ colorHex = DEFAULT_COLOR }: ItemSvgProps) => (
  <Svg width="95" height="95" viewBox="0 0 100 100">
    <Circle
      cx="50"
      cy="51"
...
export const Button2 = ({ colorHex = "#4D96FF" }: ItemSvgProps) => (
  <Svg width="95" height="95" viewBox="0 0 100 100">
    <Circle
      cx="50"
      cy="50"
...
export const StarBalloon1 = ({ colorHex = "#9B5DE5" }: ItemSvgProps) => (
  <Svg width="95" height="95" viewBox="0 0 100 100">
    <Line
      x1="50"
      y1="70"
...
export const HeartSunglasses = ({ colorHex = "#9B5DE5" }: ItemSvgProps) => (
  <Svg width="95" height="95" viewBox="0 0 100 100">
    {/* 왼쪽 하트 렌즈 (더 아래로 이동) */}
    <Path
...
export const Window1 = ({ colorHex = DEFAULT_COLOR }: ItemSvgProps) => (
  <Svg width="95" height="95" viewBox="0 0 100 100">
    <Rect
      x="20"
      y="22"
...
// // 🎁 선물상자
export const GiftBox1 = ({ colorHex = DEFAULT_COLOR }: ItemSvgProps) => (
  <Svg width="95" height="95" viewBox="0 0 100 100">
    {/* 상자 */}
    <Rect
      x="23"
...
// // 🍙 삼각김밥
// export const Block = ({ colorHex = "#FFF9F9" }: ItemSvgProps) => (
//   <Svg width="95" height="95" viewBox="0 0 100 100">
//     {/* 김밥 몸체 */}
//     <Path
//       d="M50 15 C60 15 80 50 85 80 C80 90 20 90 15 80 C20 50 40 15 50 15 Z"
//       fill={colorHex}
//       stroke={OUTLINE}
//       strokeWidth="4"
//       strokeLinejoin="round"
...
export const TriangleRuller = ({ colorHex = "#FF8B8B" }: ItemSvgProps) => (
  <Svg width="95" height="95" viewBox="0 0 100 100">
    {/* 삼각자 외곽선 */}
    <Polygon
...
// // 🍩 도넛
export const Donut1 = ({ colorHex = "#602F22" }: ItemSvgProps) => (
  <Svg width="95" height="95" viewBox="0 0 100 100">
    <Circle
      cx="50"
      cy="51"
    ...
    <Rect x="62" y="71" width="6" height="3" rx="1.5" fill="#FF6B6B" />
    <Rect x="25" y="54" width="6" height="3" rx="1.5" fill="#4CC9F0" />
    <Rect x="70" y="51" width="6" height="3" rx="1.5" fill="#FFD166" />
  </Svg>
);

export const Orange = ({ colorHex = "#FFA630" }: ItemSvgProps) => (
  <Svg width="95" height="95" viewBox="0 0 100 100">
    <Circle
      cx="50"
      cy="54"
...
// // 🧀 치즈 조각 (네모난 슬라이스 치즈)
export const Cheese = ({ colorHex = "#FFD166" }: ItemSvgProps) => (
  <Svg width="95" height="95" viewBox="0 0 100 100">
    <Rect
      x="20"
      y="20"
